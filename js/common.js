        ...
        makeDH: function() {
            ...
            function(v, C) {
                ...
                function(m) {
                    ...
                    return "<li" + (m.moreBank ? ' class="moreBank"': "") + '><a href="' + m.url + '" title="' + m.title + '"><img data-src="' + m.img + '" /></a>' + (m.ccUrl ? '<div class="info' + (m.type && !w.isIE6 ? " info" + m.type: "") + '"><p class="phone">' + m.phone + '</p><p class="cc"><a href="' + m.ccUrl + '">\u4fe1\u7528\u5361\uff1e</a></p></div>': "") + "</li>"
                }).join("") + "</ul>"
